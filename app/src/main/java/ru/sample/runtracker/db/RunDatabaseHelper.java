package ru.sample.runtracker.db;
...
import ru.sample.runtracker.Run;

/**
 * Помошник создания БД
 */
public class RunDatabaseHelper extends SQLiteOpenHelper{
    ...
    // Вставка значений координат и др. данных в БД
    ...
    // возвращает объект RunCursor со списком всех серий, упорядоченным по дате
